...
def _generate_script(subject: str, params: dict) -> str:
    ...
    if (params.get("content_format") or "short") == "long":
        ...
        prompt = (
            ...
            "paragraphs. Open with ONE SHORT sentence — at most about 10 words — that lands "
            "the viewer's pain, doubt, or question up front, so they feel 'yes, that's exactly "
            "my problem' in the first two seconds. Do NOT wind up with a multi-clause scenario "
            "or a pile of setup details before the pain: the first sentence must hit the pain "
            ...
            "not a Follow ask. FORBIDDEN anywhere in the script: Follow, Follow tomorrow, "
            "Siga, Siga-amanhã, 'follow for more', waitlist, owera.com, "
            "Owera Cloud-as-product, 'part 2 coming', SMY, Instagram, LinkedIn. "
